...
public class ComprobanteController {
	...
	public String crearComprobante(@PathVariable(value = "userUsername") String userUsername, Map<String, Object> model,
	...
	@GetMapping(value = "/ver_comprobante/{id_comprobante}")
	public String ver_comprobante(@PathVariable(value = "id_comprobante") Integer id_comprobante, Model model,
			RedirectAttributes flash) {

		Comprobante comprobante=comprobanteServiceImpl.buscarporID(id_comprobante);
		if(comprobante==null) {
			flash.addFlashAttribute("error","El comprobante no existe" );
			
			return "redirect:/";
		}
		model.addAttribute("comprobante", comprobante);
		model.addAttribute("titulo", "Detalle Comprobante");
		
		return "comprobante/ver_comprobante";
	}
